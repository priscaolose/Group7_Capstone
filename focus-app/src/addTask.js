...
const AddTask = () => {
  ...
  // Add these CSS styles directly to ensure scrolling works
  useEffect(() => {
    ...
    <div style={{
      ...
      <ThemeProvider theme={theme}>
        ...
        <div style={{
          ...
          padding: isSmallScreen ? '10px 16px 80px 16px' : '20px 48px 80px 48px'
        }}>
              ...
              <Grid2 xs={12} md={6} container direction="column" spacing={3} >
                <Grid2 container alignItems="center" justifyContent="space-between">
                  <Grid2 container direction="column" spacing={1} alignItems="flex-start">
                    <Grid2 item>
                      <h4 className="task-title" style={{ margin: 0, color: 'black' }}>Add New Task</h4>
                    </Grid2>
      ...
      {/* Add CSS directly to make sure scrolling works */}
      <style>{`
        html, body, #root {
        ...
        /* Ensure scrolling works on mobile devices too */
